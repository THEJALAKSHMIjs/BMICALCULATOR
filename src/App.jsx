...
function getstatus(bmi){
  ...
  return (
    <>
     <div className='main'>
      <div className='sub p-5 text-center text-info'><h1>BMI CALCULATOR</h1>
       ...
       <form action="" className='mt-5'>
         ...
         <Button variant="contained" className='w-50 p-3 me-3' color='info' disabled={isheight && isweight?false:true} onClick={handleCalculate} >Calculate</Button>
